...
<body>
        ...
        <div class="card">
            ...
            <div style="margin-bottom:15px;">
                ...
                <input type="text" id="searchInput" onkeyup="filterCards()"
                    placeholder="جستجو بر اساس نام دانش‌آموز یا موضوع..." style="width:100%;">
    ...
    <div class="modal-overlay" id="detailModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h3 id="modalStudentName" style="margin:0; color:#dc2626;">
                </h3>
    ...
    <script>
        ...
        function filterCards() {
            ...
            let cards =
                document.getElementsByClassName('disc-mini-card');
