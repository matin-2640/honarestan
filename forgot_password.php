...
<div id="forgot-card" class="step-box">
    ...
    <!-- مرحله ۲: نمایش شماره تلفن و دریافت کد تایید -->
    <div id="step-2" class="hidden">
        <h3>تایید شماره تلفن</h3>
        <p>کد تایید به شماره زیر ارسال خواهد شد:</p>
        
        <!-- استایل جهت نمایش استاندارد شماره تلفن (چپ به راست) -->
        <p id="masked-phone" style="font-weight: bold; letter-spacing: 2px; direction: ltr; display: inline-block; unicode-bidi: embed;"></p>
...
$(document).ready(function() {
    ...
    // مدیریت فوکوس و ورودی کادرهای OTP
    $('.otp-input').on('input keyup', function(e) {
        let $this = $(this);
        
        if (e.type === 'keyup' && e.keyCode === 8) { // کلید Backspace
        ...
        // بررسی پر شدن هر ۶ باکس به صورت خودکار
        let enteredCode = '';
    ...
    // اعتبارسنجی خودکار همراه با انیمیشن
