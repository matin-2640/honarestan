...
<head>
    ...
    <title>ویرایش اطلاعات هنرجوی | پورتال هنرستان</title>
        ...
        <div class="panel-container header-wrapper">
            <div class="user-profile-brief">
                ...
                <div class="user-info-text">
                    ...
                    <small>ویرایش اطلاعات هنرجو</small>
                </div>
            </div>
    ...
    <main class="panel-container profile-layout">
        ...
        <section class="profile-card">
            <div class="profile-card-header">
                ...
                <h2 class="profile-student-name">فرم ویرایش اطلاعات هنرجو</h2>
                <p class="profile-student-sub">مشخصات زیر را با دقت وارد نموده و سپس دکمه ثبت نهایی را بزنید.</p>
            </div>


            <form action="edit_student_back.php" method="POST" class="register-form">
                ...
                <div class="profile-info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <input type="text" id="Stu_fullName" name="Stu_fullName" class="info-value-box input-field"
                            placeholder="مثال: رضا احمدی" required value="<?php echo $student['Stu_fullName'] ?>" />
                    </div>

                    <div class="info-item">
                        <label for="Stu_nationalCode">کد ملی <span class="required-star">*</span></label>
                        <input type="text" id="Stu_nationalCode" name="Stu_nationalCode"
                            class="info-value-box input-field font-en" placeholder="0012345678" maxlength="10"
                            value="<?php echo $student['Stu_nationalCode']; ?>" required />
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <input type="tel" id="Stu_phone" name="Stu_phone" class="info-value-box input-field font-en"
                            ...
                            value="<?php echo $student['Stu_phone']; ?>" />
                    </div>

                    <div class="info-item">
                        <label for="Stu_classID">کلاس / پایه تحصیلی <span class="required-star">*</span></label>
                        <div class="select-wrapper">
                            <select id="Stu_classID" name="Stu_classID" class="info-value-box input-field select-field"
                                required>
                                ...
                                while ($class = $stmt_class->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    $selected = ($class["C_ID"] == $student["Stu_classID"]) ? "selected" : "";
                    ...
                    <div class="info-item">
                        ...
                        <input type="text" id="Stu_fatherName" name="Stu_fatherName" class="info-value-box input-field"
                            placeholder="<?php if ($student["Stu_fatherName"] == "")
                                echo "تعریف نشده"; ?>" value="<?php echo $student['Stu_fatherName']; ?>" />
                    </div>

                    <div class="info-item">
                        <label for="Stu_fatherPhone">شماره تلفن همراه پدر</label>
                        <input type="tel" id="Stu_fatherPhone" name="Stu_fatherPhone"
                            class="info-value-box input-field font-en" placeholder="<?php if ($student["Stu_fatherPhone"] == "")
                                echo "تعریف نشده"; ?>" />
                    </div>
                ...
                <div class="profile-actions-footer register-actions">
                    <button type="submit" class="btn-back-home  btn-listr">
                ...
                if (isset($_SESSION['edit_student'])) {
                    ...
                    <div class="add_success">
                        <span>اطلاعات هنرجو با موفقیت ویرایش شد</span>
                    </div>
                    <?php
                }
