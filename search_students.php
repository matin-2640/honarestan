...
// تعداد نمایش هنرجویان در هر صفحه
...
if (!empty($keyword)) {
    // جستجو همزمان بر اساس: نام، شماره تلفن و کد ملی
...
try {
    ...
    // ارسال پاسخ: [تعداد کل نتایج, لیست دانش آموزان, تعداد کل صفحات]
    echo json_encode([$total_students, $students_list, $total_pages]);
