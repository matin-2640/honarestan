        ...
        <nav id="ramSidebar" class="ram-sidebar">
            ...
            <div class="ram-nav">
                <ul>
                    ...
                    <li>
                        <a href="classes_list.php" class="ram-active"><img src="images/icons/school.png" width="20"
    ...
    <main class="panel-container list-layout">
        <section class="list-section-card">
            ...
            <div class="list-footer-actions">
                ...
                <a href="students_list.php" class="btn-back-panel" style="margin-right: 10px;">مشاهده لیست هنرجویان</a>
            </div>
        </section>
    </main>
    <?php
