...
<div class="container">
    ...
    <div class="card">
        <div class="card-title">
            <svg viewBox="0 0 24 24"><path d="M12 2L1 21h22L12 2zm1 14h-2v-2h2v2zm0-4h-2v-4h2v4z"/></svg>
        ...
        <form method="POST" action="">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="incident_date" id="incidentDate" placeholder="انتخاب تاریخ..." autocomplete="off" required>
                </div>
                ...
                <div class="form-group full-width">
                    <label>شرح کامل وقوع حادثه (حداکثر ۴۰۰ کاراکتر):</label>
                    <textarea name="description" id="descInput" rows="4" maxlength="400" placeholder="توضیحات دقیق حادثه..." oninput="updateCharCount()" required></textarea>
