          ...
          ?>
                      <article class="news-card" onclick="openNewsModal(
                        ...
                        <div class="news-img-wrapper" style="height: 180px; overflow: hidden;">
                          <img class="gallery-img" src="<?php echo htmlspecialchars($image); ?>" alt="<?php echo htmlspecialchars($title); ?>" style="width:100%; height:100%; object-fit:cover;" />
                        </div>
                        <div class="news-body">
                          <div class="news-meta">
    ...
    <section class="news-list-section">
          ...
          if (isset($connect)) {
            ...
            while ($row = $news_query->fetch(PDO::FETCH_ASSOC)) {
              ...
              <article class="news-card" onclick="openNewsModal(this)" data-title="<?php echo $title; ?>"
                ...
                <div class="news-img-wrapper" style="height: 180px; overflow: hidden;">
                  <img class="gallery-img" src="<?php echo $image; ?>" alt="<?php echo $title; ?>"
      ...
      <div class="news-modal" id="newsModal"
        ...
        <div class="back-to-home-container" style="text-align: center; margin-top: 40px;">
          <a href="index.php" class="btn-back-home" style="display: inline-flex; align-items: center; gap: 8px; background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 12px 25px; border-radius: 8px; font-weight: bold;">
