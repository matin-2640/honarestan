            ...
            if (move_uploaded_file($fileTmpName, $fileDestination)) {
                ...
                try {
                    ...
                    $stmt = $connect->prepare(
                        "INSERT INTO Notes 
                        (title, file_path, class_id, teacher_id) 
                        VALUES 
                        (:title, :file_path, :class_id, :teacher_id)"
                    );
...
if (isset($connect) && $connect) {
    ...
    try {
        ...
        $notes_query = "
            ...
            ORDER BY C.C_Grade ASC, C.C_Major ASC, N.id DESC
        ";
    ...
    <form action="" method="POST" enctype="multipart/form-data" id="uploadForm">
        ...
        <div class="form-group">
            ...
            <input
                ...
                name="title"
                required
                placeholder="مثلاً: ۱۰ شبکه - فصل اول"
            >
        ...
        <div class="form-group">
            ...
            <small class="help-text">
                پسوندهای مجاز: عکس، PDF، ورد، پاورپوینت، اکسس، اکسل، SQL، TXT
            </small>
...
<section class="notes-section">
    ...
    <div
        id="selectDisplayHint"
        class="select-hint"
    >
        لطفا نوع نمایش را انتخاب کنید
    </div>
    ...
    >
        ...
        <?php if (!empty($my_notes)): ?>
            ...
            <?php foreach ($my_notes as $note): ?>
                ...
                <div
                    class="note-box"
                    data-class-id="<?php echo htmlspecialchars($note['class_id']); ?>"
                >
                    ...
                    <div class="note-actions">
                        ...
                        <button
                            ...
                            onclick="editNote(
                                <?php echo $note['id']; ?>,
                                '<?php echo addslashes(htmlspecialchars($note['title'])); ?>'
                            )"
                        >
            ...
            >
                برای این کلاس جزوه‌ای ثبت نشده است.
            </div>

        <?php else: ?>

            <div class="no-notes">
                هنوز هیچ جزوه‌ای آپلود نکرده‌اید.
            </div>
...
$(document).ready(function () {
    ...
    $('#classFilter').on('change', function () {
        ...
        $('.note-box').each(function () {
            ...
            var noteClass = $(this).attr('data-class-id');
