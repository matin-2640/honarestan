...
if (isset($_POST['action']) && $_POST['action'] === 'delete_assignment') {
    ...
    try {
        ...
        if ($assignment) {
            if (
                !empty($assignment['file_path']) &&
                $assignment['file_path'] !== 'none' &&
                file_exists($assignment['file_path'])
            ) {
                unlink($assignment['file_path']);
            }

            $delStmt = $connect->prepare("
    ...
    if (!empty($new_title) && !empty($new_expiration_date)) {
        try {
            ...
            if ($currentAssignment) {
                ...
                if (
                    isset($_FILES['edit_file']) &&
                    $_FILES['edit_file']['error'] !== UPLOAD_ERR_NO_FILE
                ) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_assignment'])) {
    ...
    if (empty($title) || empty($class_id) || empty($expiration_date)) {
        ...
        if (
            ...
            $_FILES['assignment_file']['error'] !== UPLOAD_ERR_NO_FILE
        ) {
        ...
        <form action="" method="POST" enctype="multipart/form-data" id="uploadForm">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="title"
                    required
                    placeholder="مثلاً: تمرین سری اول - پودمان دوم">
                ...
                <select id="class_id" name="class_id" required>
                    ...
                    if (!empty($classes)) {
                        foreach ($classes as $class) {
                            echo '<option value="' .
                                htmlspecialchars($class['C_ID']) .
                                '">' .
                                htmlspecialchars($class['C_Grade']) .
                                ' ' .
                                htmlspecialchars($class['C_Major']) .
                                '</option>';
                        }
                    }
                    ?>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    data-jdp
                    required
                    placeholder="جهت باز شدن تقویم کلیک کنید"
                    autocomplete="off"
                    readonly>
            ...
            <div class="form-group">
                ...
                <small class="help-text">
                    در صورت نیاز می‌توانید فایل مربوطه را پیوست کنید.
                </small>
    ...
    <section class="notes-section">
        ...
        <div class="notes-header-filter">
            ...
            <div>
                ...
                <label
                    for="classFilter"
                    style="font-size:0.9rem; margin-left:6px;">
        ...
        <div class="notes-grid">
            ...
            <div id="selectDisplayMessage" class="no-notes">
            ...
            <?php if (!empty($my_assignments)): ?>
                ...
                <?php
                $todayJalali = normalizeJalaliDate(
                    getTodayJalaliDate()
                );
                ?>
                ...
                <?php foreach ($my_assignments as $assignment): ?>
                    ...
                    <div
                        class="note-box assignment-item"
                        data-class-id="<?php echo htmlspecialchars($assignment['class_id']); ?>"
                        style="display:none;">
                        ...
                        <?php if (!empty($assignment['expiration_date'])): ?>
                            ...
                            <span
                                ...
                                style="
                                    margin-top:6px;
                                    color:<?php echo $isExpired ? '#ef4444' : '#6b7280'; ?>;
                                    font-weight:bold;
                                    text-align:center;
                                ">
                ...
                <div
                    id="noAssignmentsFilter"
                    class="no-notes-filter">

                    برای این کلاس تمرینی ثبت نشده است.
    ...
    <div class="modal-card">
        ...
        <form
            ...
            <div class="form-group">
                ...
                <label for="modal_expiration_date">
                    مهلت تحویل (تقویم):
                </label>
            ...
            <div class="form-group">
                ...
                <label for="modal_file">
                    فایل جدید (در صورت نیاز به تغییر):
                </label>
                ...
                <small class="help-text">
                    اگر فایلی انتخاب نکنید، فایل قبلی تغییری نمی‌کند.
                </small>
            ...
            <div
                ...
                <button
                    ...
                    style="background:var(--input-border);color:var(--text-primary);">
...
$(document).ready(function () {
    ...
    $('#classFilter').on('change', function () {
        ...
        $('#selectDisplayMessage').hide();

        if (selectedClass === '') {

            $('#selectDisplayMessage').show();
        ...
        $('.assignment-item').each(function () {
            ...
            if (
                selectedClass === 'all' ||
                $(this).attr('data-class-id') === selectedClass
            ) {
