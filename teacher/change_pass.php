...
<body>
    <header class="panel-header">
        <div class="panel-container header-wrapper">
            ...
            <nav class="panel-nav" id="panelNav">
                ...
                <a href="../teacher_panel.php" class="back-link-btn">
                    <svg viewBox="0 0 24 24" class="nav-svg-icon">
    ...
    <main class="panel-container profile-layout">
        <section class="profile-card">
            ...
            <form action="change_pass_back.php" method="POST" class="register-form">
                ...
                <div class="profile-info-grid">
                    ...
                    <div class="info-item">
                        <label for="T_password">رمز عبور فعلی<span class="required-star">*</span></label>
                        <input type="text" id="T_password" name="T_password" class="info-value-box input-field"
                            required />
                        <label for="T_newPassword"> رمز عبور جدید <span class="required-star">*</span></label>
                        <input type="password" id="T_newPassword" name="T_newPassword"
