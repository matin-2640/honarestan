...
<html lang="fa" dir="rtl">
  <head>
    ...
    <title>پنل کاربری دانش‌آموز | پورتال هنرستان</title>
      ...
      <div class="panel-container header-wrapper">
        <div class="user-profile-brief">
          ...
          <div class="user-info-text">
            <span>پنل کاربری دانش‌آموز</span>
            ...
            <li>
              <a href="hNews.html" class="news-item-link">
                ...
                <span class="news-title-text"
                  >خبر ۱: زمان‌بندی دقیق امتحانات نهایی اعلام شد</span
                >
              </a>
            </li>
            <li>
              <a href="hNews.html" class="news-item-link">
                <span class="news-bullet"></span>
                <span class="news-title-text"
                  >خبر ۲: کارگاه برنامه‌نویسی پایتون ویژه تابستان</span
                >
              </a>
            </li>
            <li>
              <a href="hNews.html" class="news-item-link">
                <span class="news-bullet"></span>
                <span class="news-title-text"
                  >خبر ۳: نتایج مسابقات عکاسی استانی مشخص شد</span
                >
              </a>
            </li>
            <li>
              <a href="hNews.html" class="news-item-link">
                <span class="news-bullet"></span>
                <span class="news-title-text"
                  >خبر ۴: راه‌اندازی کارگاه حسابداری تحت وب هنرستان</span
                >
              </a>
            </li>
            <li>
              <a href="hNews.html" class="news-item-link">
                <span class="news-bullet"></span>
                <span class="news-title-text"
                  >خبر ۵: اردو علمی بازدید از پارک علم و فناوری</span
                >
              </a>
            </li>
          </ul>
